    ...
    void LateUpdate()
    {
        ...
        if (IsLeft)
        {
            if (mLeftCameraDataAcquired && mRightCameraDataAcquired)
            {
				...
				mLeftCamera.SetStereoProjectionMatrix((Camera.StereoscopicEye)mLeftCamera.stereoActiveEye,mLeftCamera.GetStereoProjectionMatrix((Camera.StereoscopicEye)mLeftCamera.stereoActiveEye));
				mRightCamera.SetStereoProjectionMatrix((Camera.StereoscopicEye)mRightCamera.stereoActiveEye,mRightCamera.GetStereoProjectionMatrix((Camera.StereoscopicEye)mRightCamera.stereoActiveEye));
